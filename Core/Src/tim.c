...
void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = TIM1;
  htim1.Init.Prescaler = 23;//f = 24/(23+1)=1MHz
  htim1.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim1.Init.Period = 39; //f= 1/(39+1)= 0.025MHz = 25KHz, T= 1/25=0.04ms.
...
void MX_TIM3_Init(void)
{
  ...
  htim3.Init.Period = 499;//65535; 5KHz
  ...
  sConfigOC.OCMode = TIM_OCMODE_PWM1;
  sConfigOC.Pulse = 250; //PWM of duty 50%
  sConfigOC.OCPolarity = TIM_OCPOLARITY_HIGH;
  sConfigOC.OCFastMode = TIM_OCFAST_DISABLE;
...
void MX_TIM14_Init(void)
{
  ...
  htim14.Init.Period = 9999; //F = 1MHz/(9999+1)= 0.1KHz, T = 1/F = 1/0.1 = 10ms
...
/* TIM17 init function */
/* fan by PWM output */
void MX_TIM16_Init(uint8_t tim,uint8_t duty)
{
